...
INSERT INTO
  `dep_user` (`id`, `dep_id`, `user_id`, `role_id`)
VALUES
  (46, 1, '497574d6-686f-4b29-99d3-082e13395bf2', NULL);
INSERT INTO
  `dep_user` (`id`, `dep_id`, `user_id`, `role_id`)
VALUES
  (47, 1, '8f080fd2-eb93-496b-b850-e2a483463e0b', NULL);
INSERT INTO
  `dep_user` (`id`, `dep_id`, `user_id`, `role_id`)
VALUES
  (48, 1, '4f8a7c25-d1a8-4c03-8ff1-4f65b9b99d8a', NULL);
INSERT INTO
  `dep_user` (`id`, `dep_id`, `user_id`, `role_id`)
VALUES
  (49, 3, '287e8184-49c6-4bb7-a824-9e02b89e1628', NULL);
INSERT INTO
  `dep_user` (`id`, `dep_id`, `user_id`, `role_id`)
VALUES
  (50, 0, 'aca1e92d-51bf-446c-9f19-435c9ff956be', NULL);
INSERT INTO
  `dep_user` (`id`, `dep_id`, `user_id`, `role_id`)
VALUES
  (51, 1, 'aca1e92d-51bf-446c-9f19-435c9ff956be', NULL);
...
VALUES
  (
    'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6IkFETUlOIiwiaWF0IjoxNTk0NDI3NTU5LCJleHAiOjE1OTQ1MTM5NTl9.JDfBFGJirKvJ5GoeJ7t0ZijdN_gCeQ7YWoGOHU5AAl8',
    'ADMIN',
    '2020-07-11 08:32:39',
    86400,
    'Mozilla/5.0 (Windows NT 10.0; Wi',
...
VALUES
  (
    'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6IkFETUlOIiwiaWF0IjoxNTk0NTkyOTYwLCJleHAiOjE1OTQ2NzkzNjB9.bvFgvS3DU2mW9fo9oAcuP5CVSEzkB_s2xXmKylykqYU',
    'ADMIN',
    '2020-07-13 06:29:20',
    86400,
    'Mozilla/5.0 (Windows NT 10.0; Wi',
...
VALUES
  (
    'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6IkFETUlOIiwiaWF0IjoxNTk0NTkzMDMwLCJleHAiOjE1OTQ2Nzk0MzB9.NxVzyQbzzUSWAt1K24eIERE4Mu5vqIqOhmdnptic9ss',
    'ADMIN',
    '2020-07-13 06:30:30',
    86400,
    'Mozilla/5.0 (Windows NT 10.0; Wi',
...
VALUES
  (
    'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6IkFETUlOIiwiaWF0IjoxNTk0NTkzMDk4LCJleHAiOjE1OTQ2Nzk0OTh9.TlFSGa6RvQOoO2WA1fNv8LGaG-axTzoXEyUNxPDGZUk',
    'ADMIN',
    '2020-07-13 06:31:38',
    86400,
    'Mozilla/5.0 (Windows NT 10.0; Wi',
...
VALUES
  (
    'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6IkFETUlOIiwiaWF0IjoxNTk0NjkzNjk0LCJleHAiOjE1OTQ3ODAwOTR9.m_KghysHWp0xTZKf2MaLN1Qo3whXQ4R1mynN-_LHK54',
    'ADMIN',
    '2020-07-14 10:28:14',
    86400,
    'Mozilla/5.0 (Windows NT 10.0; Wi',
...
VALUES
  (
    'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6IkFETUlOIiwiaWF0IjoxNTk0ODAwMjYwLCJleHAiOjE1OTQ4ODY2NjB9.EWjhkONmFSjyT2IO-qn_18TpJxaW9qhBkaCvAFSOFZU',
    'ADMIN',
    '2020-07-15 16:04:20',
    86400,
    'Mozilla/5.0 (Windows NT 10.0; Wi',
...
VALUES
  (
    'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6IkFETUlOIiwiaWF0IjoxNTk0ODg4ODU1LCJleHAiOjE1OTQ5NzUyNTV9.bHAAGYco8-LzhAS1E-EvocRaho0gn5Ay52lsf_75bUE',
    'ADMIN',
    '2020-07-16 16:40:55',
    86400,
    'Mozilla/5.0 (Windows NT 10.0; Wi',
...
VALUES
  (
    '497574d6-686f-4b29-99d3-082e13395bf2',
    '41236',
    '512313',
    '',
    '512313',
...
VALUES
  (
    '8f080fd2-eb93-496b-b850-e2a483463e0b',
    '412367',
    '451341477',
    '',
    '512313',
...
VALUES
  (
    '4f8a7c25-d1a8-4c03-8ff1-4f65b9b99d8a',
    '41236766',
    '4513414774',
    '',
    '512313',
...
VALUES
  (
    '287e8184-49c6-4bb7-a824-9e02b89e1628',
    '51234',
    '551231',
    '',
    '12414',
...
VALUES
  (
    '6f42a76a-5961-4072-9c4f-d5b4f2388eda',
    '5125',
    '412',
    '',
    '1231',
...
VALUES
  (
    '2f2887b9-4cec-40fb-8ee9-3ecb8d286c52',
    '44234',
    NULL,
    '',
    '5523',
...
VALUES
  (
    'aca1e92d-51bf-446c-9f19-435c9ff956be',
    '11111',
    '11111',
    '',
    '1111',
